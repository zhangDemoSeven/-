...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url :path+"/menu/show.do" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><font color="red" size="7">精</font></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">石家庄北大青鸟精英班提示</div>'+
							'<div class="input_btn">'+
...
function getMessage(){
		$.ajax({
			...
			success:function(data){
				...
				//初始化消息弹窗内容 background-color: #393D49;  color: #fff; 
