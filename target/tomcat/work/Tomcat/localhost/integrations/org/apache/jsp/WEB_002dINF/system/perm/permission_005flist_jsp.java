 ...
 * Generated at: 2018-12-04 06:30:16 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.system.perm;
...
public final class permission_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t    \t<input id=\"permissionName\" type=\"text\" value=\"\"  placeholder=\"请输入权限名称\" class=\"layui-input search_input\">\r\n");
      out.write("\t\t    </div>\r\n");
      out.write("\t\t    <a onclick=\"queryPermission()\" class=\"layui-btn search_btn\" ><b>查询</b></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-inline\">\r\n");
      out.write("\t\t\t<a class=\"layui-btn linksAdd_btn\"  onclick=\"o();\" style=\"background-color:#5FB878\"><b>新增权限</b></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-inline\">\r\n");
      out.write("\t\t\t<a class=\"layui-btn linksAdd_btn\"  onclick=\"u();\" style=\"background-color:#FFB800\"><b>修改信息</b></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-inline\">\r\n");
      out.write("\t\t\t<a class=\"layui-btn layui-btn-danger batchDel\" onclick=\"d();\"><b>删除权限</b></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-inline\">\r\n");
      out.write("\t\t\t<a class=\"layui-btn linksAdd_btn\"  onclick=\"p();\" style=\"background-color:#2F4056\"><b>启禁操作</b></a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</blockquote>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"table-responsive\">\r\n");
      out.write("\t\t<table class=\"table table-striped table-hover\" id=\"permTable\" style=\"text-align:center\"></table>\r\n");
      out.write("\t</div> \r\n");
      out.write("</body>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function(){\r\n");
      out.write("\t\r\n");
      out.write("\tinitPermTable();\r\n");
      out.write("\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function initPermTable(){\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#permTable\").bootstrapTable({\r\n");
      out.write("\t\ttoolbar:'#tb',\r\n");
      out.write("\t\turl:getRootPath() + \"/permission/get/list.do\",\r\n");
      ...
      out.write("\t\t\t\tpermissionName:$(\"#permissionName\").val(),\r\n");
      out.write("\t\t\t};\r\n");
      ...
      out.write("\t\t\t{field : 'name',title : '权限名称',titleTooltip : '这是权限的名称',align : 'center'},\r\n");
      out.write("\t\t\t{field : 'keyword',title : '关键字',align : 'center'},\r\n");
      out.write("\t\t\t{field : 'description',title : '权限描述',align : 'center'},\r\n");
      ...
      out.write("\t\tcontent:getRootPath() + \"/permission/show/addentity.do\",\r\n");
      out.write("\t\tarea:['60%','60%'],\r\n");
      out.write("\t\ttitle:'添加或修改权限',\r\n");
      out.write("\t\ttype:2,\r\n");
      ...
      out.write("\t\t\t$(\"#permTable\").bootstrapTable('refresh');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\tvar rows = $(\"#permTable\").bootstrapTable('getSelections');\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tvar permissionId = rows[0].id;\r\n");
      out.write("\t\r\n");
      out.write("\tparent.layer.open({\r\n");
      out.write("\t\tarea:['60%','60%'],\r\n");
      out.write("\t\ttitle:'添加或修改权限',\r\n");
      ...
      out.write("\t\tshadeClose:true,\r\n");
      out.write("\t\tmaxmin:true,\r\n");
      out.write("\t\tcontent:getRootPath() + \"/permission/show/addentity.do?permissionId=\"+permissionId,\r\n");
      out.write("\t\tbtn:[\"提交\",'取消'],\r\n");
      out.write("\t\tbtnAlign:'c',\r\n");
      out.write("\t\tyes:function(index,layero){\r\n");
      out.write("\t\t\tvar body = layer.getChildFrame('body', index);\r\n");
      ...
      out.write("\tvar permissionId = rows[0].id;\r\n");
      out.write("\t\r\n");
      out.write("\tparent.layer.confirm('您确定要操作该条数据吗?',{title:'启禁确认'}, \r\n");
      out.write("\t\tfunction(index){\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype:'POST',\r\n");
      out.write("\t\t\t\tdataType:'json',\r\n");
      out.write("\t\t\t\turl:getRootPath()+'/permission/opt/entity.do',\r\n");
      out.write("\t\t\t\tdata:{\"permissionId\":permissionId},\r\n");
      ...
      out.write("\tvar permissionId = rows[0].id;\r\n");
      out.write("\t\r\n");
      out.write("\tparent.layer.confirm(\"您确定要删除吗?\",function(index){\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\ttype:'POST',\r\n");
      out.write("\t\t\t\tdataType:'json',\r\n");
      out.write("\t\t\t\turl:getRootPath()+'/permission/del/entity.do',\r\n");
      out.write("\t\t\t\tdata:{\"permissionId\":permissionId},\r\n");
      out.write("\t\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\t\tparent.layer.msg(data.message);\r\n");
      out.write("\t\t\t\t\tparent.layer.close(index);\r\n");
      ...
      out.write("\t\tfunction(index){\r\n");
      out.write("\t\t\tlayer.close(index);\r\n");
      out.write("\t\t\tlayer.msg(\"取消了操作\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function queryPermission(){\r\n");
      out.write("\t$(\"#permTable\").bootstrapTable('refresh');\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
